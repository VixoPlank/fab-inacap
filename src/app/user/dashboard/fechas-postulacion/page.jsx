...
const months = [
  ...
  },
  {
    ...
    days: [
      ...
      { date: "2022-02-28", isCurrentMonth: true, isToday: true },
      { date: "2022-03-01" },
      { date: "2022-03-02" },
      { date: "2022-03-03" },
      { date: "2022-03-04" },
...
const page = () => {
  return (
    <div>
      <header>
        <h1 className="text-3xl text-center">Fechas de Postuación</h1>
      </header>
      <div className="relative grid grid-cols-1 gap-x-14 md:grid-cols-2 pt-9">
        <button
          type="button"
